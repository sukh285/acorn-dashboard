...
const DashRevenue = () => {
  return (
    <div>
      {/* ROW 1: LEFT TO RIGHT (Revenue + Cards) */}
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-12 gap-3">
          ...
          <div className="md:col-span-4 grid grid-cols-3 gap-2.5">
            ...
            <div className="bg-white rounded-xl border border-border/60 shadow-sm flex flex-col items-center justify-center py-2 gap-0.5 h-[95px]">
              ...
              <span className="bg-gray-100 text-text-secondary text-[9px] font-bold px-1.5 py-0.5 rounded-full">
                256
              </span>
      ...
      {/* ROW 2: User Stats & Details Button */}
      <div className="flex items-center justify-between gap-0 pt-2 w-full">
        {/* Users and Company Stats in a rounded/gray area */}
        <div className="flex-1 flex">
          <div className="flex flex-wrap items-center gap-4 p-1 bg-gray-100 rounded-full w-full">
            {/* User 1: Armin */}
            <div className="flex items-center bg-white gap-2 rounded-full p-1">
              <Avatar
                src="https://i.pravatar.cc/150?u=Armin"
                size="sm"
                className="size-6!"
              />
              <span className="font-bold text-text-primary text-sm">$209,633</span>
              <span className="text-text-secondary font-medium text-[10px] ml-[200px]">
                39.63%
              </span>
            </div>
            {/* User 2: Mikasa */}
            <div className="flex items-center bg-white gap-2 rounded-full p-1">
              <Avatar
                ...
                className="!size-6"
              />
              <span className="font-bold text-text-primary text-sm">$156,841</span>
              <span className="text-text-secondary font-medium text-[10px] ml-[150px]">
                29.65%
              </span>
            </div>
            {/* User 3: Eren (Jean in mock) */}
            <div className="flex items-center bg-white gap-2 rounded-full p-1">
              <Avatar
                ...
                className="!size-6"
              />
              <span className="font-bold text-text-primary text-sm">$117,115</span>
              <span className="text-text-secondary font-medium text-[10px] ml-1">
                22.14%
              </span>
            </div>
            {/* Company Stat */}
            <div className="flex items-center gap-2">
              <div className="size-6 bg-black text-white rounded-full flex items-center justify-center text-[10px] font-bold">
                C
              </div>
              <span className="font-bold text-text-primary text-sm">$45,386</span>
              <span className="text-text-secondary font-medium text-[10px] ml-1">
                8.58%
              </span>
            </div>
        ...
        {/* Details Button, almost no gap to previous col, fixed width */}
        <button className="ml-2 bg-black text-white px-5 py-2 rounded-full text-xs font-bold hover:bg-gray-800 transition shadow-lg shadow-black/20 flex-shrink-0">
          Details
        </button>
      </div>
    </div>
